...
from __future__ import (
    absolute_import, annotations, division, unicode_literals,
)
...
from typing import (
    TYPE_CHECKING, Any, AnyStr, ClassVar, Optional, Type,
)

import param

from panel.models.jstree import jsTreePlot
...
class _jsTreeBase(Widget):
    ...
    url = param.String(doc="ajax url")  # not used currently
